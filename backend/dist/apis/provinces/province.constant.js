...
exports.VIETNAM_PROVINCE_CODE_SET = exports.VIETNAM_PROVINCES = void 0;
exports.isVietnamProvinceCode = isVietnamProvinceCode;
exports.normalizeVietnamProvinceCode = normalizeVietnamProvinceCode;
...
exports.VIETNAM_PROVINCE_CODE_SET = new Set(exports.VIETNAM_PROVINCES.map((p) => p.code));
function isVietnamProvinceCode(code) {
    return exports.VIETNAM_PROVINCE_CODE_SET.has(code);
}
/** Chuẩn hóa mã client gửi lên (trim + IN HOA) trước khi kiểm tra / lưu. */
function normalizeVietnamProvinceCode(value) {
    return value.trim().toUpperCase();
}
const EXPECTED_PROVINCE_COUNT = 34;
if (exports.VIETNAM_PROVINCES.length !== EXPECTED_PROVINCE_COUNT) {
    throw new Error(`VIETNAM_PROVINCES must contain exactly ${EXPECTED_PROVINCE_COUNT} entries, got ${exports.VIETNAM_PROVINCES.length}`);
}
//# sourceMappingURL=province.constant.js.map