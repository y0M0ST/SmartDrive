 ...
 *     tags: [DriverAccounts]
 *     description: Super Admin co the tao tai khoan cho tai xe cua bat ky dai ly nao. Agency Manager chi duoc tao tai khoan cho tai xe trong dai ly cua minh. Hay lay driver_id tu API danh sach tai xe va dung email lam dinh danh dang nhap cua tai xe.
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 *       required: true
