 ...
 *     tags: [Drivers]
 *     description: Agency Manager chỉ xem được tài xế thuộc đại lý của mình. Super Admin có thể xem mọi tài xế.
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *     responses:
 *       200:
 *         description: Lấy chi tiết tài xế thành công
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                 message:
 *                   type: string
 *                   example: Lấy chi tiết tài xế thành công
 *                 data:
 *                   $ref: '#/components/schemas/DriverResponse'
 */
