 ...
 *     tags: [Vehicles]
 *     description: Agency Manager chỉ xem được xe thuộc đại lý của mình. Super Admin có thể xem mọi xe.
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *     responses:
 *       200:
 *         description: Lấy chi tiết xe khách thành công
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                 message:
 *                   type: string
 *                   example: Lấy chi tiết xe khách thành công
 *                 data:
 *                   $ref: '#/components/schemas/VehicleResponse'
 */
 ...
 *     tags: [Vehicles]
 *     description: Super Admin có thể gán xe vào bất kỳ đại lý active nào. Agency Manager chỉ tạo xe trong đại lý của mình. Mã Camera AI là tùy chọn và được lưu qua edge_devices.
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 *       required: true
 ...
 *                 message:
 *                   type: string
 *                   example: Xóa xe khách thành công
 *                 data:
